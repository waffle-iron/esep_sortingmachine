...
SignalBitmask AsyncChannel::BUTTON_START_PUSHED(0b00010000<<8, "BUTTON_START_PUSHED");
...
SignalBitmask AsyncChannel::LIGHT_BARRIER_INPUT_NOT_INTERRUPTED(0b00000001, "LIGHT_BARRIER_INPUT_NOT_INTERRUPTED");
SignalBitmask AsyncChannel::LIGHT_BARRIER_HEIGHT_NOT_INTERRUPTED((int)(0b00000010), "LIGHT_BARRIER_HEIGHT_NOT_INTERRUPTED");
